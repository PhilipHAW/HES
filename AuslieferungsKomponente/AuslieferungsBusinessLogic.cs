...
namespace AuslieferungsKomponente
{
    public class AuslieferungsBusinessLogic
    {
        ...
        public AuslieferungsBusinessLogic( LieferungsVerwalter auslieferungsVerwalter, TransportAuftragsVerwalter transportAuftragsVerwalter, ITransportDienstleisterMgmt transportDienstleisterManager)
        {
